...
#       time.sleep(3)
    ...
    def test_assignee(self):
        ...
        time.sleep(3)
        self.driver.find_element(By.XPATH, "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.RelativeLayout[4]/android.widget.LinearLayout/android.widget.ImageView[1]").click()
        time.sleep(3)
        self.driver.find_element(By.ID, 'com.telocks.te:id/rbRecurring').click()
        time.sleep(3)
        self.driver.find_element(By.ID, 'com.telocks.te:id/ctvM').click()
        time.sleep(3)
        self.driver.find_element(By.ID, 'com.telocks.te:id/ctvTH').click()
        time.sleep(3)
        self.driver.find_element(By.XPATH, "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[4]/android.widget.LinearLayout[2]/android.widget.LinearLayout[1]/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.TextView").click()
        time.sleep(3)
        self.driver.find_element(By.XPATH, '//android.widget.RadialTimePickerView.RadialPickerTouchHelper[@content-desc="8"]').click()
        time.sleep(3)
        self.driver.find_element(By.XPATH, '//android.widget.RadialTimePickerView.RadialPickerTouchHelper[@content-desc="30"]').click()
        time.sleep(3)
        self.driver.find_element(By.ID, 'android:id/button1').click()
        time.sleep(3)
        self.driver.find_element(By.XPATH, '/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[4]/android.widget.LinearLayout[2]/android.widget.LinearLayout[2]/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.TextView').click()
        time.sleep(3)
        self.driver.find_element(By.XPATH, '//android.widget.RadialTimePickerView.RadialPickerTouchHelper[@content-desc="9"]').click()
        time.sleep(3)
        self.driver.find_element(By.XPATH, '//android.widget.RadialTimePickerView.RadialPickerTouchHelper[@content-desc="45"]').click()
        time.sleep(3)
        self.driver.find_element(By.ID, 'android:id/button1').click()
        time.sleep(3)
        #self.driver.find_element(By.XPATH, 'com.telocks.te:id/ctaUpdate').click()
        #time.sleep(3)
